...
<div class="tpl-content-wrapper" >
    ...
    <ol class="am-breadcrumb">
        ...
        <li><a href="#">分类管理</a></li>
        <li class="am-active">添加子类</li>
    </ol>
<div class="tpl-portlet-components l-height" >
    <div class="portlet-title">
        <div class="caption font-green bold">
            <span class="am-icon-plus"></span> 添加子类
        </div>
            ...
            <div class="am-u-sm-12 am-u-md-9">
                <form class="am-form am-form-horizontal" >
                    <div class="am-form-group">
                        <label for="father" class="am-u-sm-3 am-form-label">父类</label>
                        <div class="am-u-sm-9">
                            <input type="text" name="father" value="{{$data['title']}}" id="father" disabled>
                            <small class='little'></small>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label for="title" class="am-u-sm-3 am-form-label">子类</label>
                        <div class="am-u-sm-9">
...
<script type="text/javascript">
    $('button[type=button]').click(function(){
       ...
       $.ajax({
            type:'POST',
            url:"{{url('/admin/videoType/storeSon/'.$data['id'])}}",
